...
function getPointGen() {
	...
	if (hasUpgrade('L', 15)) gain = gain.pow(1.1)
	if (hasUpgrade('L', 21)) gain = gain.times(0.5)
	if (hasUpgrade('L', 22)) gain = gain.times(10)
	if (hasUpgrade('L', 23)) gain = gain.times(upgradeEffect('L', 23))
